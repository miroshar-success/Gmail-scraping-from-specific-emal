...
func main() {
        ...
        r, err := srv.Users.Messages.List(user).Q("from:" + os.Args[2]).MaxResults(50).Do()
        if err != nil {
        ...
        for _, msg := range r.Messages {
                ...
                if fromCache {
                        fmt.Println("load from cache")
                        continue
                }
                fmt.Println("load from mail box")
